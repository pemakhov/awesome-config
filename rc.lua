...
beautiful.init("/home/pemakhov/.config/awesome/themes/varnitsa/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "web", "dev", "fls", "trm", "cht", "pic", "etc", "etc", "tls" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "l",     function () awful.spawn.with_shell("gnome-screensaver-command --lock") end,
...
clientkeys = gears.table.join(
    ...
    -- My key bindings section
    awful.key({ modkey,           }, "F4",      function (c) c:kill()               end,
              {description = "close", group = "client"}),
    awful.key({ modkey,           }, "F9",      function () awful.spawn.with_shell("xbacklight -dec 10") end,
...
awful.rules.rules = {
    ...
    -- Set apps to always map on the tag name on screen 1.
...
do
	-- Run startup scripts
	awful.spawn.with_shell("sh ~/.config/awesome/scripts/startup-scripts.sh")
end
